...
folder checkpoints, EXIF/XMP/IPTC extraction, explicit single/folder refresh plus the 0.8.29 resumable whole-library metadata reindex, diagnostics, the 0.8.38 filtered MyPicsDB 3 log export and missing-record handling.
